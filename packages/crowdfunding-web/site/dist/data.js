...
export const project = {
    ...
    description: "Financer la restauration progressive du mur pignon (18 m) : consolidation et maçonnerie à la chaux, avec une documentation complète des étapes.",
    objectiveAmount: 45000,
    collectedAmount: 12850,
    currency: "EUR",
    hero: {
        imageAlt: "Mur pignon du Manoir de la Chevallerie – état initial",
        caption: "Mur pignon – vue générale avant travaux. Les désordres observés justifient une intervention progressive.",
    ...
    works: {
        ...
        method: "Les interventions sont menées de manière progressive, mètre par mètre, en privilégiant des matériaux et techniques traditionnels.",
        transparency: "Chaque étape fait l’objet d’un suivi documenté (photographies, notes de chantier), publié régulièrement.",
    },
    followup: {
    ...
    contribute: {
        ...
        footnote: "Selon la plateforme et le cadre de collecte, un reçu fiscal peut être disponible. Nous indiquons les modalités sur la page de don.",
    },
    footerText: "Page de suivi autonome — Manoir de la Chevallerie. Contact et informations complémentaires via le site officiel et le journal de chantier.",
    rewards: {
        intro: "Les contreparties sont proposées à titre de remerciement, selon le montant du don.",
        items: [
            {
                minAmount: 20,
                title: "Remerciements",
            ...
            },
            {
                minAmount: 50,
                title: "Visite",
                description: "Invitation à une visite commentée à une date dédiée (places limitées).",
            },
            {
                minAmount: 150,
                title: "Mécène du chantier",
                description: "Mention sur un support de suivi du chantier (selon accord).",
            },
        ],
    ...
    milestones: [
        ...
        },
        {
            ...
            description: "Pierres de rive / éléments sculptés : restauration et finitions.",
        },
    ],
    supporters: {
